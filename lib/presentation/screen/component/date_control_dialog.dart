...
class DateControlDialog {
  ...
  void showScheduleDatePicker(
      BuildContext context, Schedule schedule, bool repeatFlag) {
    showCupertinoDialog(
        context: context,
                      ...
                      children: [
                        ...
                        Expanded(
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              if (repeatFlag)
                                repeatScheduleOnOtherDate(schedule, dateTime);
                              else
                                changeScheduleDate(schedule, dateTime);
                              Navigator.of(context).pop();
                              Navigator.of(context).pop();
                            },
                            style: ElevatedButton.styleFrom(
                              elevation: 0,
                              backgroundColor:
                              ColorResource.BUTTON_NORMAL_COLOR,
                              shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(6.0),
                              ),
                            ),
